...
import { ABOUT_PILLARS, STATS } from '@/lib/data'
...
export function About() {
  ...
  const activePillar = ABOUT_PILLARS[activePillarIndex]
            ...
            <Reveal delay={100} direction="right">
              <div className="group relative overflow-hidden rounded-2xl border border-border/70 bg-secondary p-5 text-secondary-foreground shadow-xl sm:p-6">
                ...
                <blockquote className="mt-3 font-serif text-base italic leading-relaxed text-secondary-foreground/95 sm:text-lg">
                  &ldquo;Language isn&apos;t memorized from a dry textbook — it truly sticks when learners can touch it, build with it, and laugh along the way.&rdquo;
                </blockquote>

                <div className="mt-4 flex items-center justify-between border-t border-white/10 pt-3 text-xs text-secondary-foreground/75">
                  <span className="font-semibold text-primary">— Farah Affes</span>
          ...
          <div className="flex flex-col gap-6">
            ...
            <Reveal delay={60}>
              <div className="space-y-3.5 text-sm leading-relaxed text-muted-foreground sm:text-base text-pretty">
                <p>
                  As an English educator and specialized learning material crafter, I bridge the gap between academic linguistic theory and joyful, hands-on classroom immersion.
                </p>
                <p>
                  Every worksheet, phonics wheel, and interactive game is engineered to lower learners&apos; affective anxiety and build enduring speaking confidence.
                </p>
              </div>
            </Reveal>
